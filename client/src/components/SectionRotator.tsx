/**
 * SectionRotator — cinematic crossfading image pool for any framed section.
 * Same engine as HeroRotator: shuffle-per-visit, crossfade, Ken Burns drift,
 * next-frame preload, pause-on-hidden, full prefers-reduced-motion respect.
 * Drop inside any element with position:relative; overflow:hidden.
 */
...
export function SectionRotator({
  images,
  intervalMs = 6000,
  className = "",
}: {
